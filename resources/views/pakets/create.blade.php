          ...
          <div class="row align-items-center">
            <div class="col-md-12">
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="/pakets/create">Tambah Paket</a></li>
              </ul>
            </div>
            <div class="col-md-12">
              <div class="page-header-title">
                <h2 class="mb-0">Tambah Paket</h2>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="container">
            <form action="{{ route('pakets.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="e_commerce" name="e_commerce" required>
                </div>
                <div class="form-group">
                    <label for="berat_barang">Berat Barang (kg)</label>
                    <input type="number" class="form-control" id="berat_barang" name="berat_barang" step="0.01" required>
                </div>
