          ...
          <div class="row align-items-center">
            <div class="col-md-12">
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="transaksis">Transaksi</a></li>
              </ul>
            </div>
            <div class="col-md-12">
            ...
            <div class="container">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped align-middle">
                        ...
                        <tbody>
                            @forelse($semuaTransaksi as $index => $paket)
                                <tr>
                                    <td>{{ $index + 1 }}</td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center justify-content-between">
                                            <span id="resi-{{ $index }}">{{ $paket->nomor_resi }}</span>
                                            <button class="btn btn-sm btn-outline-secondary ms-2" onclick="salinResi({{ $index }})">Salin</button>
                                        </div>
                                    </td>                       
