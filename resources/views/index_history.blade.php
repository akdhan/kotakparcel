            ...
            <a href="/pakets/create" class="pc-link">
              <span class="pc-micon">
                <svg  xmlns="http://www.w3.org/2000/svg"  
                    ...
                    class="icon icon-tabler icons-tabler-outline icon-tabler-shopping-cart-plus"><path s
                    troke="none" d="M0 0h24v24H0z" fill="none"/><path d="M4 19a2 2 0 1 0 4 0a2 2 0 0 0 -4 0" />
                    <path d="M12.5 17h-6.5v-14h-2" /><path d="M6 5l14 1l-.86 6.017m-2.64 .983h-10.5" /><path d="M16 19h6" />
                    <path d="M19 16v6" />
                </svg>
              </span>
          ...
          <div class="row align-items-center">
            <div class="col-md-12">
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="history">Pesanan Selesai</a></li>
              </ul>
            </div>
            <div class="col-md-12">
              <div class="page-header-title">
                <h2 class="mb-0">Pesanan Selesai</h2>
              </div>
            </div>
          </div>
        </div>
                    ...
                    <table class="table table-bordered table-striped align-middle">
                        <thead class="table-dark text-light">
                            <tr>
                                ...
                                <th>Tanggal Paket Diterima</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach($historyPakets as $index => $historyPaket)
                                <tr>
                                    <td>{{ $index + 1 }}</td>
                                    <td>{{ $historyPaket->nama_barang }}</td>
                                    <td>{{ $historyPaket->nama_penerima }}</td>
                                    <td>{{ $historyPaket->nomor_resi }}</td>
                                    <td>{{ $historyPaket->ekspedisi }}</td>
                                    <td>{{ $historyPaket->tanggal_pemesanan }}</td>
                                    <td>{{ $historyPaket->e_commerce }}</td>
                                    <td>{{ $historyPaket->berat_barang }}</td>
                                    <td>{{ $historyPaket->tanggal_paket_diterima }}</td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
                    <a href="/" class="btn btn-outline-dark">Kembali ke Daftar Paket</a>
                </div>
        </div>
      </div>
    </div>
